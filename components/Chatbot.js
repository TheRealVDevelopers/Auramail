...
import { updateEmailFolder, getUnreadCount, sendEmail } from '../services/emailService.js';
        ...
        React.createElement('div',
            ...
            React.createElement('div', { className: "flex-1 p-4 overflow-y-auto bg-gray-50" },
                 transcript.length === 0 && !liveTranscript && (
                    React.createElement('div', { className: "text-center text-gray-500 p-4" },
                        React.createElement('p', { className: "text-sm" }, "Hi! I'm your voice assistant. How can I help you manage your email today?")
                    )
                ),
                transcript.map((item) => (
